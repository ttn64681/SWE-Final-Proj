...
export default function SmallPromo({ discount, promo, imageUrl }: SmallPromoProps) {
  return (
    <motion.div
      ...
      className="bg-black border-2 my-2 border-white/60 hover:border-acm-pink/50 flex flex-row rounded-xl overflow-hidden max-h-40 w-[400px] flex-shrink-0 transition-colors duration-200 cursor-pointer"
    >
