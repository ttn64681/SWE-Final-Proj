          ...
          <section className="p-0">
            <div className="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-y-6 gap-x-6">
              ...
              <input
                ...
                className="w-full p-3 rounded border-2 bg-[#242424] text-white font-afacad focus:outline-none"
                style={{ 
                  borderColor: "#FF478B",
                  borderWidth: "2px",
              ...
              <input
                ...
                className="w-full p-3 rounded bg-[#242424] text-white font-afacad"
                style={{ 
                  border: "2px solid #FF478B",
                  outline: "none",
                  backgroundColor: "#242424",
                  WebkitBoxShadow: "0 0 0 1000px #242424 inset",
                  WebkitTextFillColor: "white"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 rounded border-2 bg-[#242424] text-white font-afacad"
                    style={{ 
                      borderColor: "#FF478B",
                      outline: "none",
                      backgroundColor: "#242424",
              ...
              <label className="self-center text-white font-afacad text-lg font-bold">Billing Address</label>
              <input
                type="text"
