  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const registrationData = {
        ...
        country: 'US', // Default to US since we removed country selection
        // Payment info (excluding CVV for security)
        ...
        <div className="w-full max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="text-base font-semibold text-white/90 border-b border-white/10 pb-1">Payment Information</h3>
              
              <div>
                <label htmlFor="cardType" className="block text-white text-sm mb-1">Card Type</label>
                <select
                  id="cardType"
                  value={data.cardType || ''}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="expirationDate" className="block text-white text-sm mb-1">Expiration Date</label>
                  <input
                    id="expirationDate"
                    type="text"
                ...
                <div>
                  <label htmlFor="cvv" className="block text-white text-sm mb-1">CVV</label>
                  <input
                    id="cvv"
                    type="text"
                    value={data.cvv || ''}
            ...
            <div className="space-y-3">
              ...
              <div>
                <label htmlFor="billingStreet" className="block text-white text-sm mb-1">Street Address</label>
                <input
                  id="billingStreet"
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="billingCity" className="block text-white text-sm mb-1">City</label>
                  <input
                    id="billingCity"
                    type="text"
                ...
                <div>
                  <label htmlFor="billingState" className="block text-white text-sm mb-1">State</label>
                  <input
                    id="billingState"
                    type="text"
