      ...
      <main className="flex-grow p-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <Link
              href={`booking/ticket-age?seats=${encodeURIComponent(selectedSeats.length ?? 0)}&seatIds=${encodeURIComponent(selectedSeats.join(','))}&title=${encodeURIComponent(movieTitle)}&date=${encodeURIComponent(date)}&time=${encodeURIComponent(time)}`}
            >
              <button
                type="button"
                id="submitBtn"
